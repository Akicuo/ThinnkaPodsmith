...
def build_setup_script(
    ...
    if custom_dependencies:
        ...
        custom_deps_lines = [
            ...
            "import sys",
            "missing = []",
            f"packages = {custom_dependencies}",
            "for pkg in packages:",
            ...
            "        missing.append(name)",
            "if missing:",
            "    print('Warning: Some packages may not be importable: ' + ', '.join(missing), file=sys.stderr)",
            "print('Custom deps installed (pip verification passed)')",
            "PY",
        ]
